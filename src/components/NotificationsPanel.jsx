      ...
      {open && (
        <>
          <motion.div
            ...
            onClick={onClose}
          />
          {/* সেন্টার করার জন্য একটা full-screen flex wrapper — নিজে transform ব্যবহার করছে না, তাই এর ভেতরের fixed child সবসময় viewport-এর মাঝে থাকবে */}
          <div className="fixed inset-0 z-[1000] flex items-start justify-center px-4 pointer-events-none">
            <motion.div
              initial={{ opacity: 0, y: -16 }}
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -16 }}
              className="pointer-events-auto mt-20 sm:mt-24 w-full max-w-sm neo-card p-0 max-h-[75vh] overflow-hidden flex flex-col"
            >
